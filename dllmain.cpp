...
void DrawMenu() {
	...
	if (ZeroGUI::Window("DecoWare [Free Internal]", &pos, Vector2{ 500.0f, 400.0f }, ShowMenu))
	{
		//Simple Tabs
		static int tab = 0;
...
VOID Main()
{
	...
	freopen("CONOUT$", "w", stderr);*/
		...
		ue::cached::signatures::GetNameByIndex = sdkUssage->PatternScan(ue::cached::Base, xorstr("48 89 5C 24 08 48 89 74 24 18 48 89 7C 24 20 41 56 48 81 EC 30 08 ? ? 48 8B 05 F9 FD 6A 0B 48 33 C4 48 89 84 24 20 08"), 0, false); if (!ue::cached::signatures::GetNameByIndex) safe_call(MessageBox)(0, xorstr(L"GetNameByIndex"), 0, 0);
